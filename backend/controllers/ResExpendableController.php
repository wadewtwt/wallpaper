...
use backend\models\ResExpendableSearch;
use Yii;
...
class ResExpendableController extends AuthWebController
{
    // 列表
    public function actionIndex()
    {
        ...
        $searchModel = new ResExpendableSearch();
    ...
    public function actionCreate()
    {
        ...
        if($model->load(Yii::$app->request->post())){
            $model->type = Resource::TYPE_EXPENDABLE;
